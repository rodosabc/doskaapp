...
BlogItem.delete_all
BlogItem.create!(id: 0,title: 'Blog',text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus adipisci deserunt dolores eos, et fugit harum iure iusto maiores nemo nihil non numquam, quae reiciendis rem similique ullam. Labore, quo.',date: Date.today,:image => File.new("#{Rails.root}/app/assets/images/homer2.jpg"))
BlogItem.create!(id: 1,title: 'Blog',text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus adipisci deserunt dolores eos, et fugit harum iure iusto maiores nemo nihil non numquam, quae reiciendis rem similique ullam. Labore, quo.',date: Date.today,:image => File.new("#{Rails.root}/app/assets/images/homer2.jpg"))
BlogItem.create!(id: 2,title: 'Blog',text: 'Lorem ipsum dolor sit amet, consectetur adipisicing elit. Accusamus adipisci deserunt dolores eos, et fugit harum iure iusto maiores nemo nihil non numquam, quae reiciendis rem similique ullam. Labore, quo.',date: Date.today,:image => File.new("#{Rails.root}/app/assets/images/homer2.jpg"))
